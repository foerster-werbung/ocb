...
Take a look at the [FoersterWerbung-GmbH/octobertricks.com](https://github.com/FoersterWerbung-GmbH/octobertricks.com) repo to see an example setup of `oc-bootstrapper`.
...
plugins:
    ...
    - Rainlab.Builder
    - Indikator.Backend
    - FoersterWerbung.SiteSearch
    - FoersterWerbung.ResponsiveImages
    - FoersterWerbung.GDPR (https://github.com/FoersterWerbung-GmbH/oc-gdpr-plugin.git)
    - ^FoersterWerbung.Mall (https://github.com/FoersterWerbung-GmbH/oc-mall-plugin.git#develop)
...
- FoersterWerbung.Mall (https://github.com/FoersterWerbung-GmbH/oc-mall-plugin.git)
